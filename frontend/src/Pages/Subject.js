...
function createSubject(subject, lecturer, semester, branch) {
    return { subject, lecturer, semester, branch };
}
...
export default function Subject() {
    ...
    const handleAddEntry = () => {
        setRows((prevRows) => [...prevRows, subjectData]);
        setSubjectData({
            subject: '',
            lecturer: '',
            semester: '',
    ...
    return (
        <Container maxWidth='lg' sx={{ py: 3 }}>
            <Typography variant='h3' textAlign='center'>Subject Registration</Typography>
